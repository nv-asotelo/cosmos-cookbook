---
name: cosmos-brev-deploy
description: Deploy a Cosmos Cookbook recipe to a Brev GPU instance with zero-trust auth checks, provider selection, recipe demo scripts, and known Brev runtime bug workarounds.
